        ...
        @forelse($charges as $charge)
            <div class="bg-white p-5 rounded-3xl shadow-sm border border-slate-100/50 active:scale-[0.98] transition-all">
                ...
                <div class="flex items-end justify-between">
                    ...
                    @else
                        @if(isset($charge['documents']) && count($charge['documents']) > 0)
                            <button onclick="window.location.href='{{ $charge['documents'][0]['url'] }}'" class="text-primary hover:scale-110 transition-transform">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                            </button>
                        @else
                            <button class="text-slate-200 cursor-not-allowed" title="Aucun document">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                            </button>
